...
class _AuthCardState extends State<AuthCard> with TickerProviderStateMixin {
  ...
  void _submit() async {
    ...
    try {
      ...
      if (error.toString().contains("EMAIL_EXISTS")) {
        errorMsg = "This email is already registered. Try other email or login";
      } else if (error.toString().contains('INVALID_EMAIL')) {
        errorMsg = "The entered email is invalid.";
      } else if (error.toString().contains('WEAK_PASSWORD')) {
        errorMsg = "The password is too weak.";
      } else if (error.toString().contains('EMAIL_NOT_FOUND')) {
        errorMsg = "The entered email is not registered.";
      ...
      print(error);
      const errorMsg = "Unknown error. Please try again later";
      showAlertMsg(errorMsg);
    }
  ...
  void showAlertMsg(String errorMsg) {
    showDialog(
        context: context,
        builder: (ctx) {
          return AlertDialog(
